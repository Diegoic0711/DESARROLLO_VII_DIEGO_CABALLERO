...
$miArray = ["Digimon", "pokemon", "One Piece", "Dragon Ball"]; // Reemplaza esto con tu propio array
$miString = "Perro"; // Reemplaza esto con tu propio string
$miNumero = 7; // Reemplaza esto con tu propio número
