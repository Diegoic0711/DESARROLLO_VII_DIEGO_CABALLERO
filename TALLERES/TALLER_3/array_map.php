...
$nombres = ["Diego","Ana", "Carlos", "Beatriz"];
$apellidos = ["Batista","García", "Rodríguez", "López"];
...
$productos = [
    ...
    ["nombre" => "Trombon", "precio" => 1200]
];

$productosConDescuento = array_map(function($producto) {
    $producto['precio_descuento'] = $producto['precio'] * 0.30; // 10% de descuento
    return $producto;
}, $productos);
